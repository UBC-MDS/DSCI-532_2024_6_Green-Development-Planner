...
# Pie Charts
energy_consumption_pie_chart = dvc.Vega(id='pie-chart', opt={'actions': False}, style={'width': '100%'})
electricity_generation_pie_chart = dvc.Vega(id='electricity-production', opt={'actions': False}, style={'width': '100%'})
